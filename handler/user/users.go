...
func (u *Users) Login(context *gin.Context) {
	...
	if userModel != nil {
		...
		if userToken, err := userTokenFactory.GenerateToken(userModel.Id, userModel.Login, sqlType, variable.ConfigYml.GetInt64("Token.JwtTokenCreatedExpireAt")); err == nil {
