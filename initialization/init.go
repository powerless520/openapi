...
import (
	"DTCloudAPI/config/configuration"
	"DTCloudAPI/global/errno"
	"DTCloudAPI/global/variable"
	"DTCloudAPI/util/gorm_v2"
	"DTCloudAPI/validator/common/register_validator"
	"log"
	"os"
)
...
func checkRequiredFolders() {
	...
	if _, err := os.Stat(variable.BasePath + "/conf/gorm_v2.yaml"); err != nil {
		log.Fatal(errno.ErrorsConfigGormNotExists + err.Error())
	}
	//2.检查public目录是否存在
